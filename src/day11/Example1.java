...
public class Example1 { // class start
    public static void main(String[] args) { // main start
            ...
            [ ArrayList ] 가변길이 , 다양한 메소드 제공
                ...
                3. 사용법
                    ...
                    2) 요소 추가
                        ...
                        * 인덱스란? 배열또는리스트 내 저장된 (요소)값들의 저장순서번호 , 0번 시작
                    3) 출력/반환
                        (1) 변수명                 : 전체 요소값 문자열 출력
                    ...
                    5) 요소 삭제
                        (1) 변수명.remove( 인덱스 ) : 지정한 인덱스 요소 값 삭제

                4. 리스트와 반복문 관계
                    (1) 일반 반복문
                        for( int i =0 ; i <리스트변수명.size(); i++){
                            항목타입 변수면2 = 리스트변수명.get( i );
                        }
                    (2) 향상된 반복문
                        for ( 항목타입 변수명 : 리스트변수명 ){
        ...
        */
        ...
        // 2) <Memeber> 타입/클래스 의 객체 3개를 저장할 ArrayList 객체 생성
        ArrayList< Member > memberList = new ArrayList<>(); // < 작은괄호에는 리스트/목록 내 저장할 항목의타입
        // 3) 리스트에 객체들을 저장하기.
        memberList.add( m1 );
        memberList.add( m2 );
        memberList.add( m3 );
