...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        [ 스레드 Thread ]
            ...
            3. 자바 에서의 스레드
                1) main 메소드 : public static void main( String[] args ){} 에는 main스레드가 내장 된
            4. 사용법
                1) 자바 프로그램은 항상 main 메소드(Thred)로 부터 실행 흐름 시작된다.
                public static void main( String[] args ){}

        [ 멀티스레드 Multi-Thread ]
            1. 정의 : main 스레드 외 새로운 *작업스레드를 생성하여 동시 작업
        ...
        */
        ...
        // 1) 출력 5번
        System.out.println("[1] MAIN 스레드가 읽어드리는 코드"); // main 메소드가 처리하는 코드
        for( int i = 1 ; i <=5 ; i++){
            System.out.println("[1] MAIN 스레드가 읽어드리는 코드");
        } // for end
        // 2) 소리 5번
        for( int i = 1 ; i <=5 ; i++){
            System.out.println("[1] 띵 소리");
            toolkit.beep(); // '띵' 소리 제공하는 메소드( 띵 하는 도중에 반복문 종료된다.)
            try { Thread.sleep(1000); // Thread.sleep( 밀리초 ) : 현재 스레드를 밀리초 만큼 일시정지*예외발생
            }catch (Exception e){ System.out.println(e);}
        } // for end

        // [2] 멀티 스레드 에 : 익명 구현체 : 인터페이스타입을 클래스없이 직접 구현
        ...
        // 2) 출력 5번
        for( int i = 1 ; i <=5 ; i++){
            System.out.println("[2] MAIN 스레드가 읽어드리는 코드");
            try {
                Thread.sleep(1000);
            }catch (Exception e){};
        } // for end
        ...
        // 2) 출력 5번
        for( int i = 1 ; i <=5 ; i++){
            System.out.println("[3] MAIN 스레드가 읽어드리는 코드");
            try {
                Thread.sleep(1000);
            }catch (Exception e){};
        } // for end
        ...
        // 2) 출력 5번
        for( int i = 1 ; i <=5 ; i++){
            System.out.println("[4] MAIN 스레드가 읽어드리는 코드");
            try {Thread.sleep(1000);
            }catch (Exception e){};
        } // for end
