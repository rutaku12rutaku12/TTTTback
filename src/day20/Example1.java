...
public class Example1 { // class start
    public static void main(String[] args) { // main start
        ...
        [ 자바의 기본 클래스 ]
            ...
            3. Wrapper 클래스 : 8가지 기본타입을 참조타입 사용
                ...
                주요메소드 :
                    ...
                    2) String.valueOf( 자료 ); * 자료 --> 문자열

            4. localDateTime 클래스 : 시스템의 날짜/시간 정보 클래스
                특징 : 날짜/시간 정의/형식/세부/계산
                주요메소드
                    1. LocalDateTime.now() ; 시스템의 현재 날짜/시간을 갖는 LocalDateTime객체 반환
                    ...
                    + 패턴 : y연도 M월 d일 h시 m분 s초 대소문자 구분!
                    10. .plusDays( 일수 ) : 객체내 일수를 더한 결과를 LocalDateTime 반환
                    10. .minusDays( 일수 ) : 객체내 일수를 뺀 결과를 LocalDateTime 반환
        ...
        */
        ...
        Object o4 = "휴재석";            // 문자열를 Object 분류할 수 있다.
        ...
        System.out.println( o8.toString() );
            ...
            // 2. == 변수가 갖는 값/주소 비교 .equals( ) : 주소가 갖는 값 비교
        ...
        System.out.println( str1.equals(str2) ); // true 주소가 갖는 값 같음
        ...
        // .getConstructors() : 클래스/타입 의 모든 생성자명 반환
        ...
        // [4]
        // 1. 현재 날짜의 시간 생성
        LocalDate localDate = LocalDate.now(); // 2025-07-25
        ...
        localDateTime.of( 2025, 7, 25 , 11 , 30, 15);
        ...
        // 5. 날짜 계산
        LocalDateTime 더한날짜 = localDateTime.plusDays(30);
        System.out.println(더한날짜);
        LocalDateTime minus = localDateTime.minusDays(60);
