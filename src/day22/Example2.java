        ...
        [ Random ] 난수 클래스
            1. 사용법
                ...
                2) 주요 메소드
                    ...
                    .nextInt( N );               : 0부터 N-1 사이의 난수 생성
                    .nextInt( N )+ 시작값       : 시작값 부터 N 사이의 난수 생성
        */
        // 1. Random 객체 생성
        ...
        for( int i = 1; i <=6 ; i ++ ) {
            ...
            lottoList.add ( lotto ); // 생성된 로또 번호들 리스트에 담기
        }
        System.out.println(lottoList);

        // 활용6] 하나의 문자열에서 추출한 문자로 문자열 난수 생성
        String ranStr2 = "ABCAasdfdzsfszfzdf34623464356364#$^$#%#$%!$~!@SDFASEFASDFSDFASsadfsad3w6#$@#%@DF";
