    ...
    public static void main(String[] args) { // main start
        ...
        /*
            [반복문]
                ...
                2. 형태
                    ...
                    - 증감식 : 반복변수의 증(가) 또는 감(소) 변화 식 *주로 반복횟수 증강 , i++
        ...
        */
        ...
        for( int 곱 = 1 ; 곱<=9 ; 곱++){System.out.println(곱);}
            // 합치기 : (1) 단 마다  ( 2x1 2x2 ~~~ ), (2) 곱 마다 단 ( 2x1 3x1 ~~~ )
        for( int 단 = 2 ; 단<=9; 단++) {
            for (int 곱 =1 ; 곱<=9; 곱++){
