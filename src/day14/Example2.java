...
public class Example2 { // class start
    public static void main(String[] args) { // main start
        ...
        // !! : Tire 타입의 멤버변수는 Tire객체,HankookTire객체,KumhoTire객체를 모두 대입 받을수 있다.
        ...
        // 이유 : KumhoTire 객체아 생성될때 : KumhoTire , Tire 총 2개 생성
        // 하위타입의 객체를 생성하면 상위타압의 객체도 같이 생성된다.
        // 즉] KumhoTire 객체가 생성될때 HankkokTire 객체는 생성되지 않는다. (형제관계라서)
