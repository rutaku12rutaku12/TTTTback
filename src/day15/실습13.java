...
public class 실습13 { // class start
    public static void main(String[] args) { // main start
        ...
        if(duck1 instanceof Flyable){ ((Flyable) duck1).fly(); };
        if(duck1 instanceof Swimmable){ ((Swimmable) duck1).swimmable(); };
        ...
        // [10]
        Calculator.plus(10,20); // static 으로 정의되어 객체 생성없이 메소드사용
