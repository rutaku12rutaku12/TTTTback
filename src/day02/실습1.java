package day02; // 현재 . java 파일의 폴더/패키지 위치

public class 실습1 { // 자바코드는 모두 클래스안에서 작성해야한다. // class시작
...
//
    ...
    public static void main(String[] args) {
        System.out.println(25);             // !! 명령어 끝에 ; 세미몰론 필수
...
//
    ...
    int age = 40;   // int(저장곤간크기) age(공간이름) =(대입) 40(리터럴/재료);
