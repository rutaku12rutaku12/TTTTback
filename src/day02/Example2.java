...
/*
        ...
        //          (1) .next() : 키보드로부터 입력받은 문자열(String) 반환 , 단] 띄어쓰기 불가능.
                    ...
                    (2) .nextLine() : 입력받은 문자열(String) 반환 , 단] 띄어쓰기 가능.
                        *주의할점 : nextLine() 앞에 다른 next()가 존재하면 enter(완료) 를 하나로 포함 하므로 문제발생
 ...
 */
        ...
        // 6. nextLong(); : 입력받은 정수(long) 반환 , 입력값이 long 하용범위 벗어나면 오류
        ...
        // 8. nextDobule(); : 입력받은 실수(double) 반환 , 입력값이 double 허용범위 벗어나면 오류
        ...
        // 10. next().charAt( 0 ); : 입력받은 문자열 중에 첫번째 글자 반환 , *nextChar() 없다.
