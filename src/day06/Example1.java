    ...
    public static void main(String[] args) { // main start
        ...
        /* [ 배열 ]
                ...
                3. 사용법
                    ...
                    4) 삭제/추가 * 특정한 요소 삭제/추가 는 존재하지 않는다. 자바 배열은 *고정길이* 이므로 중간에 요소 개수 변경할수 없다.
                    5) 배열과 반복문
                        (1) 일반 for문
                        for( int index = 0; index<= 배열.length-1; index++){
                            타입 변수명 = 배열변수명[index];
                        }
        ...
        */
        ...
        for( String value : array2 ){   // 향상된for문 , for( 요소타입 반복변수명 : 배열변수명 ) { } 자바스크립트에서 향상된 for문>>for( let 변수명 of 배열변수명 ) { }
            System.out.println(value);
        }   // for end
