...
//        char ch3 = "ABC";   // "" 감싼 자료 도 불가능
        System.out.println(ch1);
            // 3. String 클래스 : "큰따옴표 로 감싼 문자 영러개 저장;
        String  str1 = "ABC";
//        String  str2 = 'ABC'; // ''감싼 자료는 불가능
        System.out.println(str1);

            // 4. byte 타입 : 정수 - 123 ~ +127       1바이트
        byte b1 = 100 ;
...
//        short s2 = 50000;   // 불가능 : 저장 허용 범위 벗어남
        ...
        int i1 = 2100000000;
//        int i2 = 3100000000; // 불가능 : 저장 허용 범위 벗어남;
            // 7. long 타입 : 정수 +-21억 정도 이상     8바이트 , 리터럴뒤에 L/l
//        long l1 = 3000000000;   // 불가능 : 키보드로 입력한 모든 값은 (리터럴) 정수가 int 라서
        long l2 = 3000000000L;
        System.out.println(l2);
            // 8. double 타입 : 실수 소수점 17자리 까지 포함, 실수 리터럴 *
        double d1 = 0.123456789123456789123456;   // 0.12345678912345678 나머지는 짤림.
        System.out.println(d1);
            // 9. float 타입 : 실수 소수점 8자리 까지 표현 , 리터럴 뒤에 F/f
        float f1 = 0.123456789123456789123456F; // 리터럴 뒤에 F 붙인다.
