    ...
    public static void main(String[] args) { // main start
        /*
            [출력함수] :
                ...
                (3) system.out.printf( " 형식 " , 값 );          : f(Format) 정해진 형식의 맞게 출력 함수
                    [ 형식 ]
                        %s : 문자열 위치         %c : 문자 위치
                        %d : 정수 위치           %f : 실수 위치
                    [ 자릿수 맞춤 ]
        ...
        */
        ...
        int age = 40;   // int(정수타입) age(변수명) =(대입) 48(자료) ;(마침)
        System.out.printf("저는 %s 이고 나이는 %d 입니다" , name , age );
                // printf("~~~~~~~ 형식자리 ~~~~~~~~~~~~, 값1   , 값2 );==>  $s에는 name값 %d에는 age값 대입
                // vs
        ...
        System.out.println( "안녕3\t안녕4");    // \t (tap) 들여쓰기
